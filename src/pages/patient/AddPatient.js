...
import { useState } from 'react'; export default function AddPatient() {
    const [formData, setFormData] = useState({ firstName: "", middleName: "", lastName: "", mobileno: "", message: "" }); const handleChange = (event) => {
                    ...
                    <div class="card-body">
                        <form onSubmit={handleSubmit}>
                            <div class="row gx-1 align-items-left">
                                ...
                                <div class="col-2">
                                    <label mb-3="firstName" className='form-label'>Name:</label>
                                ...
                                <div class="col-2">
                                    <label for="middleName" className='form-label'>&nbsp;</label>
                                    <input type="text" id="middleName" name="middleName" className='form-control form-control-sm'
                                        value={formData.middleName} onChange={handleChange} placeholder='Middle Name' />
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <label for="message" className='form-label'>Mobile No:</label>
                                    <select id="patient_phone_country_code" className='form-control form-control-sm' name="patient_phone_country_code">
                                ...
                                <div class="col-2">
                                    ...
                                    <input type="text" id="mobileno" name="mobileno" className='form-control form-control-sm'
                                        value={formData.mobileno} onChange={handleChange} placeholder='Mobile No' />
                                </div>
                                <div class="col-4"></div>
                            </div>
                            <div class="row">
                                <div class="col-2">
                                    <label for="message" className='form-label'>Birth Date</label>
                                    <input type="text" id="birthDate" name="birthDate" className='form-control form-control-sm'
                                        value={formData.birthDate} onChange={handleChange} placeholder='Birth Date' />
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-2">
                                    ...
                                    <textarea id="message" name="message" className='form-control form-control-sm'
